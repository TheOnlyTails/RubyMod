...
fun makeRubyHills(): Biome {
	val genSettings = genSettings(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).apply {
		addStructureStart(StructureFeatures.PILLAGER_OUTPOST)
		addStructureStart(StructureFeatures.VILLAGE_PLAINS)
		addStructureStart(StructureFeatures.RUINED_PORTAL_STANDARD)
	}.also {
		DefaultBiomeFeatures.addDefaultCarvers(it)
		DefaultBiomeFeatures.addDefaultOverworldLandStructures(it)
		DefaultBiomeFeatures.addDefaultMonsterRoom(it)
		DefaultBiomeFeatures.addDefaultUndergroundVariety(it)
		DefaultBiomeFeatures.addDefaultOres(it)
		DefaultBiomeFeatures.addDefaultSoftDisks(it)
		DefaultBiomeFeatures.addMushroomFieldVegetation(it)
		DefaultBiomeFeatures.addDefaultSprings(it)
		DefaultBiomeFeatures.addDefaultLakes(it)
	}
	...
	val spawnSettings = spawnSettings()
		...
		.also {
			DefaultBiomeFeatures.farmAnimals(it)
			DefaultBiomeFeatures.commonSpawns(it)
		}
...
private fun getSkyForTemp(@Suppress("SameParameterValue") temperature: Float): Int {
